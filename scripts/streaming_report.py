#!/usr/bin/env python3
"""
MitraSETI Streaming Report Generator
...
Charts use a dark crystalline theme matching the MitraSETI aesthetic.
"""
...
<title>MitraSETI Observation Report - Day {day_number}</title>
<style>{_CSS}</style>
</head>
<body>
<div class="container">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>MitraSETI Observation - Final Summary</title>
<style>{_CSS}</style>
</head>
<body>
<div class="container">
...
<div class="summary-box">
    ...
    <p>
        Over <strong>{total_days} days</strong> ({runtime:.1f} hours), MitraSETI processed
...
<div class="footer">
    ...
    <a href="https://github.com/samantaba/MitraSETI">star the repo</a>.
</div>
